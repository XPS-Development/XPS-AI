...
from model.train.dataset_val import ValXPSDataGenerator
...
def process_real_data(json_dir, output_dir):
    ...
    if not output_path.exists():
        ...
        processor = ValXPSDataGenerator(json_dir=json_dir, output_dir=output_dir)
...
def main():
    ...
    train_dataset = XPSDataset(path_to_data)
